...
# ssm464基于java的可视化高校公寓管理系统+vue

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1t58veLEnL?p=62)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本可视化高校公寓也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让考试信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，可视化高校公寓的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，可视化高校公寓是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
信息数据的处理完全依赖人工进行操作，会耗费大量的人工成本，特别是面对大量的数据信息时，传统人工操作不仅不能对数据的出错率进行保证，还容易出现各种信息资源的低利用率与低安全性问题。更有甚者，耽误大量的宝贵时间，尤其是对信息的更新，归纳与统计更是耗财耗力的过程。所以电子化信息管理的出现就能缓解以及改变传统人工方式面临的处境，一方面可以确保信息数据在短时间被高效处理，还能节省人力成本，另一方面可以确保信息数据的安全性，可靠性，并可以实现信息数据的快速检索与修改操作，这些优点是之前的旧操作模式无法比拟的。因此可视化高校公寓为数据信息的管理模式的升级与改革提供了重要的窗口。
## 1.3 论文结构安排
...
# 4 系统设计
可视化高校公寓的设计方案比如功能框架的设计，比如数据库的设计的好坏也就决定了该系统在开发层面是否高效，以及在系统维护层面是否容易维护和升级，因为在系统实现阶段是需要考虑用户的所有需求，要是在设计阶段没有经过全方位考虑，那么系统实现的部分也就无从下手，所以系统设计部分也是至关重要的一个环节，只有根据用户需求进行细致全面的考虑，才有希望开发出功能健全稳定的程序软件。
## 4.1 系统概要设计
...
图4.1 程序工作的原理图
## 4.2 系统功能结构设计
在分析并得出使用者对程序的功能要求时，就可以进行程序设计了。如图4.2展示的就是管理员功能结构图，管理员在后台主要管理班级管理、每日打卡管理、字典管理、访客管理、宿舍缴费记录管理、离校登记管理、宿舍管理、宿舍管理员管理、物品进出登记管理、学生管理、住宿信息管理、管理员管理等。
...
![C:\Users\Administrator\Desktop\img\keshihuagongyu\宿舍.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\宿舍.jpg")
图4.1 宿舍实体属性图

（2）下图是每日打卡实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\每日打卡.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\每日打卡.jpg")
图4.2 每日打卡实体属性图

（3）下图是物品进出登记实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\物品进出登记.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\物品进出登记.jpg")
图4.3 物品进出登记实体属性图

（4）下图是离校登记实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\离校登记.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\离校登记.jpg")
图4.4 离校登记实体属性图

（5）下图是住宿信息实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\住宿信息.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\住宿信息.jpg")
图4.5 住宿信息实体属性图

（6）下图是访客实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\访客.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\访客.jpg")
图4.6 访客实体属性图

（7）下图是学生实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\学生.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\学生.jpg")
图4.7 学生实体属性图

（8）下图是宿舍缴费记录实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\宿舍缴费记录.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\宿舍缴费记录.jpg")
图4.8 宿舍缴费记录实体属性图

（9）下图是班级实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\班级.jpg](/md/blog.017.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\班级.jpg")
图4.9 班级实体属性图

（10）下图是宿舍管理员实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\keshihuagongyu\宿舍管理员.jpg](/md/blog.018.jpeg "C:\Users\Administrator\Desktop\img\keshihuagongyu\宿舍管理员.jpg")
图4.10 宿舍管理员实体属性图
### 4.3.2 数据库表结构设计
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|banji\_name|String|班级名称|是|
|3|banji\_address|String|班级位置|是|
|4|banji\_number|Integer|班级人数|是|
|5|banji\_content|String|备注|是|
...
|3|daka\_photo|String|打卡照片|是|
|4|daka\_content|String|打卡备注|是|
|5|insert\_time|Date|打卡时间|是|
...
|3|fangke\_name|String|访客姓名|是|
|4|fangke\_phone|String|访客手机号|是|
|5|fangke\_id\_number|String|访客身份证号|是|
|6|sex\_types|Integer|性别|是|
|7|fangke\_content|String|来访事由|是|
|8|laifang\_time|Date|来访时间|是|
|9|jeishu\_time|Date|结束时间|是|
...
|1|Id|Int|id|否|
|2|sushe\_id|Integer|宿舍|是|
|3|jiaofeijilu\_name|String|缴费名称|是|
|4|jiaofei\_types|Integer|缴费类型|是|
|5|jiaofeijilu\_content|String|备注|是|
|6|jiaofei\_time|Date|缴费时间|是|
...
|1|Id|Int|id|否|
|2|xuesheng\_id|Integer|学生|是|
|3|lixiao\_time|Date|离校时间|是|
|4|lixiaodengji\_content|String|登记内容|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|sushe\_name|String|宿舍房号|是|
|3|loudong\_types|Integer|所属楼栋|是|
|4|sushe\_content|String|宿舍备注|是|
|5|insert\_time|Date|添加时间|是|
|6|create\_time|Date|创建时间|是|
表4.8宿舍管理员表
...
|5|susheguanliyuan\_photo|String|宿舍管理员头像|是|
|6|susheguanliyuan\_email|String|电子邮箱|是|
|7|insert\_time|Date|添加时间|是|
|8|create\_time|Date|创建时间|是|
表4.9物品进出登记表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|loudong\_types|Integer|楼栋|是|
|3|wupinjinchu\_name|String|物品名称|是|
|4|wupinjinchu\_types|Integer|物品类型|是|
|5|wupinjinchu\_content|String|物品详情|是|
|6|wupinjinchu\_zhuangtai\_types|Integer|状态|是|
|7|jinchu\_time|Date|进出时间|是|
...
|1|Id|Int|id|否|
|2|banji\_id|Integer|班级|是|
|3|xuehao\_uuid\_number|String|学号|是|
...
|9|zhuangtai\_types|Integer|状态|是|
|10|xuesheng\_content|String|财务登记|是|
|11|create\_time|Date|创建时间|是|
表4.11住宿信息表
...
|4|zhusu\_content|String|住宿备注|是|
|5|insert\_time|Date|打卡时间|是|
|6|create\_time|Date|创建时间|是|
表4.12管理员表
...
## 5.1 管理员功能介绍
### 5.1.1 住宿信息列表
如图5.1显示的就是住宿信息列表页面，此页面提供给管理员的功能有：查看住宿信息、新增住宿信息、修改住宿信息、删除住宿信息等。

![](/md/blog.019.png)

图5.1 住宿信息列表页面
### 5.1.2 宿舍信息管理
宿舍信息管理页面提供的功能操作有：新增宿舍，修改宿舍，删除宿舍操作。下图就是宿舍信息管理页面。

![](/md/blog.020.png)

图5.3 宿舍信息管理页面
### 5.1.3楼栋类型管理
楼栋类型管理页面显示所有楼栋类型，在此页面既可以让管理员添加新的公告信息类型，也能对已有的楼栋类型信息执行编辑更新，失效的楼栋类型信息也能让管理员快速删除。下图就是楼栋类型管理页面。
